...
#' environment for the years 1950-2019, compiled and published by FAO (2021).
#'
#' @usage
#' aquaculture
#'
...
#'
#' @details
#' This data frame contains the full set of 96,308 data records from the
...
#'
#' \code{\link{fishstat21-package}} gives an overview of the package.
#'
#' @examples
#' head(aquaculture)
#'
...
#'
#' # Top 10 aquaculture species in 2019, production in tonnes
#' x <- aggregate(value~species_name, aqua, sum, subset=year==2019)
