...
#' 1950-2019, compiled and published by FAO (2021).
#'
#' @usage
#' capture
#'
...
#'
#' @details
#' This data frame contains the full set of 1,001,899 data records from the
...
#'
#' # Top 10 capture species in 2019
#' x <- aggregate(value~species_name, cap, sum, subset=year==2019)
