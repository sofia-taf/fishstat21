...
#' @title Environments
#'
#' @description Aquatic environments for aquaculture, defined by FAO (2021).
#'
#' @usage
#' environment
#'
...
#' environment
#'
#' # Aquaculture production by environment in 2019, in million tonnes
#' x <- merge(aquaculture, environment)
#' x <- aggregate(value~environment_name, x, sum, subset=year==2019)
